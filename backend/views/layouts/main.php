                    ...
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a><i class="fa fa-users"></i> Quản Lý người dùng <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="<?php echo Yii::$app->homeUrl.'admin';?>">Admin</a></li>
                                    <li><a href="<?php echo Yii::$app->homeUrl.'admin/assignment';?>">Assignment</a></li>
                                    <li><a href="<?php echo Yii::$app->homeUrl.'admin/role';?>">Role</a></li>
                                    <li><a href="<?php echo Yii::$app->homeUrl.'admin/permission';?>">Permission</a></li>
                                    <li><a href="<?php echo Yii::$app->homeUrl.'admin/route';?>">Route</a></li>
                                    <li><a href="<?php echo Yii::$app->homeUrl.'admin/user';?>">User</a></li>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <iframe src="http://local.admin.testfile.com/file/dialog.php?field_id=image" style="border: none; width: 100%; height: 500px"></iframe>
                </div>
